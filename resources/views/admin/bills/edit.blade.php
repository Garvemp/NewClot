...
@section('title', 'Editor Bills')
@section('breadcrumb')
<li class="breadcrumb-item">
    <a href="{{ url('/admin/bills') }}"><i class="fa-solid fa-money-bill"></i></i>Facturas</h2></a>
</li>
<li class="breadcrumb-item">
    <a href="{{ url('/admin/bills') }}"><i class="fa-solid fa-plus"></i>Editar Factura</h2></a>
</li>
@endsection 
...
<div class="container-fluid">
    <div class="panel shadow">
        <div class="header">
             <h2 class="title"><i class="fa-solid fa-plus"></i>Editar Factura</h2>
        </div>

        <div class="inside">
            {!! Form::model($bill, ['url' => '/admin/bill/'.$bill->id.'/edit', 'files' => true, 'method' => 'post']) !!}
