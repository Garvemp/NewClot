...
<li class="breadcrumb-item">
    <a href="{{ url('/admin/clients/add') }}"><i class="fa-solid fa-plus"></i>Agregar Clientes</h2></a>
</li>
@endsection 
...
<div class="container-fluid">
    <div class="panel shadow">
        <div class="header">
             <h2 class="title"><i class="fa-solid fa-plus"></i>Agregar Clientes</h2>
        </div>

        <div class="inside">
            {!! Form::open(['url' => '/admin/client/add']) !!}
